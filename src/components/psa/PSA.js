...
const PSA = () => {
  ...
  return (
    <div>
      Dear {loggedInUser.firstName}, this form will serve as your Personal
      Service Agreement, (PSA). Below is a listing of all the services you are
      being offered by the Erie Philharmonic for the 2022-23 season, as of April
      22, 2022. As per the Master Agreement, Article III(d), you must accept or
      ...
      position of {loggedInUser.role}. You will be paid as per the Master
